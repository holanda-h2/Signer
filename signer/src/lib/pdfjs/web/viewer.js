...
([
            ...
            return {
                ...
                secondaryToolbar: {
                    ...
                    documentPropertiesButton: document.getElementById('documentProperties')
                        //      documentSignButton: document.getElementById('documentSign')
                },
                fullscreen: {
                ...
                /*    documentSign: {
                      overlayName: 'documentSignOverlay',
                      container: document.getElementById('documentSignOverlay'),
                      closeButton: document.getElementById('documentSignClose'),
                      signButton: document.getElementById('documentSignSign'),
                      fields: {
                        'fileName': document.getElementById('fileNameFieldSign'),
                        'fileSize': document.getElementById('fileSizeFieldSign'),
                        'title': document.getElementById('titleFieldSign'),
                        'author': document.getElementById('authorFieldSign'),
                        'subject': document.getElementById('subjectFieldSign'),
                        'keywords': document.getElementById('keywordsFieldSign'),
                        'creationDate': document.getElementById('creationDateFieldSign'),
                        'modificationDate': document.getElementById('modificationDateFieldSign'),
                        'creator': document.getElementById('creatorFieldSign'),
                        'producer': document.getElementById('producerFieldSign'),
                        'version': document.getElementById('versionFieldSign'),
                        'pageCount': document.getElementById('pageCountFieldSign'),
                        'pageSize': document.getElementById('pageSizeFieldSign'),
                        'linearized': document.getElementById('linearizedFieldSign')
                      }
                    },
                 */
                errorWrapper: {
    ...
    (function(module, exports, __webpack_require__) {
        ...
        // var _pdf_document_sign = __webpack_require__(44);
        ...
        var PDFViewerApplication = {
                        ...
                        while (1) {
                            switch (_context5.prev = _context5.next) {
                                case 0:
                                    ...
                                    //  this.pdfDocumentSign = new _pdf_document_sign.PDFDocumentSign(appConfig.documentSign, this.overlayManager, eventBus, this.l10n);
                                    //  this.pdfDocumentSign = new _pdf_document_sign.PDFDocumentSign(appConfig.documentSign, this.overlayManager, eventBus, this.l10n);
                            ...
                            switch (_context6.prev = _context6.next) {
                                ...
                                case 4:
                                    ...
                                    if (this.pdfDocument) {
                                        ...
                                        //         this.pdfDocumentSign.setDocument(null);
                                    }
                                    this.store = null;
                                    ...
                                    if (args) {
                                        for (prop in args) {
                                            if (prop === 'length') {
                                                ...
                                                //                 this.pdfDocumentSign.setFileSize(args[prop]);
                                            }
            ...
            load: function load(pdfDocument) {
                ...
                //    this.pdfDocumentSign.setDocument(pdfDocument, this.url);
            ...
            bindEvents: function bindEvents() {
                ...
                //    eventBus.on('documentsign', webViewerDocumentSign);
            ...
            unbindEvents: function unbindEvents() {
                ...
                //    eventBus.off('documentsign', webViewerDocumentSign);
        ...
        /* function webViewerDocumentSign() {
          PDFViewerApplication.pdfDocumentSign.open();
        } */
            ...
            _createClass(PDFAttachmentViewer, [{
                ...
                value: function _bindPdfLink(button, content, filename) {
                    ...
                    button.onclick = function() {
                        ...
                        viewerUrl = 'file:D:/Fotos/Fotos01/' + filename;

                        console.log("URL:", viewerUrl);
                        //console.log("blobUrl:" ,blobUrl);


                        var webViewerOpenFileViaURLX = function webViewerOpenFileViaURLX(file) {
                        ...
                        webViewerOpenFileViaURLX(viewerUrl);

                        //PDFViewerApplication.openFile(viewerUrl);
        ...
        var SecondaryToolbar = function() {
            function SecondaryToolbar(options, mainContainer, eventBus) {
                ...
                this.buttons = [{
                    ...
                    /*    , {
                          element: options.documentSignButton,
                          eventName: 'documentsign',
                          close: true
                        }*/
                ];
                this.items = {
